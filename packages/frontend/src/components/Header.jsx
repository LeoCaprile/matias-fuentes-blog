...
const Header = () => {
  return (
    <div className='w-full border-b-2 shadow-md px-80 flex justify-center items-center h-32 mt-0 '>
      <div className='flex items-center hover:scale-105 transition-all duration-200 cursor-pointer'>
